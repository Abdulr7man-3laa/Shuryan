...
import { SPECIALTIES, getSpecialtyById } from '@/utils/constants';
...
const FilterChips = ({
  ...
  // Note: Filter checks both governorate AND city fields
  const cities = [
    // Major Governorates
    'القاهرة',
    'الجيزة',
    ...
    'الوادي الجديد',
    'مطروح',
    // Major Cities (in case API returns city instead of governorate)
    'مدينة نصر',
    'المعادي',
    'الزمالك',
    'المنصورة',
      ...
      <div className="flex items-center justify-center gap-3 flex-wrap">
        ...
        <div className="relative">
          ...
          <FilterPopup isOpen={openFilter === 'city'}>
            <h4 className="font-black text-slate-800 mb-3">اختر المدينة</h4>
        ...
        <div className="relative">
          ...
          <FilterPopup isOpen={openFilter === 'price'}>
            <h4 className="font-black text-slate-800 mb-3">نطاق السعر</h4>
            <div className="px-2">
              <Slider
                range
                min={0}
